...
namespace CarCenter.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            var carCenterContext = _context.Nota
                .Include(n => n.Carro)
        ...
        public IActionResult Create()
        {
            ...
            // Exibir apenas o Nome do cliente
            ViewData["CompradorId"] = new SelectList(_context.Cliente, "Id", "Nome");
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,DataEmissao,Garantia,ValorVenda,CompradorId,VendedorId,CarroId")] Nota nota)
        {
            ...
            // Manter seleção quando houver erro de validação
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["CarroId"] = new SelectList(_context.Carro, "Id", "Chassi", nota.CarroId);
            // Exibir apenas o Nome e já selecionado
            ViewData["CompradorId"] = new SelectList(_context.Cliente, "Id", "Nome", nota.CompradorId);
            ViewData["VendedorId"] = new SelectList(_context.Vendedor, "Id", "Matricula", nota.VendedorId);
            return View(nota);
        }
