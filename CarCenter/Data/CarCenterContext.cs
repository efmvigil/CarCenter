...
namespace CarCenter.Data
{
    public class CarCenterContext : DbContext
    {
        ...
        public DbSet<CarCenter.Models.Cliente> Cliente { get; set; } = default!;
        public DbSet<CarCenter.Models.Vendedor> Vendedor { get; set; } = default!;
        public DbSet<CarCenter.Models.Nota> Nota { get; set; } = default!;
    }
}
